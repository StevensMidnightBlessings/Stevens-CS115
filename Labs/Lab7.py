'''
i've found an early solution for yall boys before the 1 day extension due date! Drake drops his album wit 21 tomorrow as well. 🥳
...
def gor3(x,y,z):
 ...
 def FA(x,y,cin):
    ...
    add = XOR(XOR(x,y),cin)
    carry = gor3(gand(x,cin), gand(y,cin), gand(x,y))       
    return (carry, add) 

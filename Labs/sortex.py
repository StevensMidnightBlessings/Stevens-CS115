...
print(search([1,2,3,4,1], 3, 1))
print(search([1,2,3,0], 3, 2))
print(search([1,3,5,5], 3, 6))
print(search([0], 1, 5))
print(search([5], 1, 2))
'''
...
isLetter = ['a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p','q','r','s','t','u','v','w','x','y','z']
